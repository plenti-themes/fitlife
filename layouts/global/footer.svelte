<footer class="footer">
  <div class="section footer-top bg-dark has-bg-image" style="background-image: url('media/footer-bg.png')">
    <div class="container">
      ...
      <div class="footer-brand">
        ...
        <div class="wrapper">
          ...
          <img src="media/footer-clock.png" width="34" height="34" loading="lazy" alt="Clock">
